package net.runelite.client.plugins.viOneClickFishing;
...
import net.runelite.client.plugins.viOneClickFishing.bank.BankBase;
import net.runelite.client.plugins.viOneClickFishing.bank.ShiloVillage;
import net.runelite.client.plugins.viOneClickFishing.enums.Actions;
import net.runelite.client.plugins.viOneClickFishing.enums.Fish;
import net.runelite.client.plugins.viOneClickFishing.enums.Method;
import net.runelite.client.plugins.viUtilities.api.extensions.objects.viPlayer;
import net.runelite.client.plugins.viUtilities.api.interactions.MenuEntryInteraction;
import net.runelite.client.plugins.viUtilities.api.interactions.WalkInteractions;
import net.runelite.client.plugins.viUtilities.api.menuEntries.InventoryEntries;
import net.runelite.client.plugins.viUtilities.api.menuEntries.NpcMenuEntries;
import net.runelite.client.plugins.viUtilities.api.menuEntries.WidgetMenuEntries;
