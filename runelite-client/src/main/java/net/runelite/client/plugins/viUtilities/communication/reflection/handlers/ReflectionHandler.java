package net.runelite.client.plugins.viUtilities.communication.reflection.handlers;

import net.runelite.api.Client;
import net.runelite.client.plugins.viUtilities.communication.mappings.FieldNameMapping;
import net.runelite.client.plugins.viUtilities.communication.mappings.MethodNameMapping;
import net.runelite.client.plugins.viUtilities.communication.reflection.wrappers.ReflectedFieldWrapper;
import net.runelite.client.plugins.viUtilities.communication.reflection.wrappers.ReflectedMethodWrapper;
